...
//TODO использовать ConcurrentMap, т.к.  не синхронизирована и из-за этого периодически выскакивает NullPointerException
...
//TODO использовать ConcurrentHashMap	
